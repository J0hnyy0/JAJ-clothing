...
// Place order function - Updated to save to Firebase
    ...
    successModal.innerHTML = `
        <div class="jaj-order-success-content">
            ...
            <div class="jaj-order-details">
                ...
                <p><strong>Estimated Delivery:</strong> 3-5 business days after confirmation</p>
            </div>
            <div class="jaj-success-actions">
                <button class="jaj-btn-primary" onclick="closeSuccessModal(this)">Continue Shopping</button>
                <button class="jaj-btn-secondary" onclick="viewOrderHistory()">View Order History</button>
            </div>
        </div>
    `;
...
window.viewOrderHistory = viewOrderHistory; // Add this line